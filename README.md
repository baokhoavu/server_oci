...
### Created from The Online Check In Full MEAN Wep Application created for Causeforce. 
### Data binding is saved each component to sync with online flow step via Restful API.
### Hosted on AWS using express based server Restful for JSON POST.
